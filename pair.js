...
const fakeVCardQuoted = {
  ...
  message: {
    contactMessage: {
      displayName: "© HKTECHGOD-MD",
      vcard: `BEGIN:VCARD
VERSION:3.0
FN:© HKTECHGOD-MD
ORG:HKTECHGODMD Official;
...
await sock.sendMessage(
  jid,
  {
    image: { url: "https://o.uguu.se/VtocosOT.jpg" },
    caption,
    contextInfo: {
      mentionedJid: [jid],
      forwardingScore: 999,
...
//coded by HKTECHGOD-MD Official 🇵🇰 
